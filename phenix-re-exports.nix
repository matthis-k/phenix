{ inputs, ... }:
{
  flake = {
    ...
    nixosModules = {
      ...
      hostLaptop = inputs.phenix-hosts.nixosModules.laptop;
      hostDesktop = inputs.phenix-hosts.nixosModules.desktop;
      ...
      desktopEnvironment = inputs.phenix-de.nixosModules.desktop;
